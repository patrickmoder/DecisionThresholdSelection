...
class Player(BasePlayer):
    ...
    strategy_when = models.IntegerField(label='&emsp;If yes, after how many rounds did you adjust the strategy?', max=17, min=1, blank=True)
